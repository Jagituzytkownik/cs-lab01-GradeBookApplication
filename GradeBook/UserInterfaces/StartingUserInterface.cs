...
namespace GradeBook.UserInterfaces
{
    public static class StartingUserInterface
    {
        ...
        public static void CreateCommand(string command)
        {
            ...
            var IsWeight = parts[3] == "true" ? true : false;
            var name = parts[1];
            if (parts[2] == "standard") 
            {
                BaseGradeBook gradeBook = new StandardGradeBook(name,IsWeight);
                 Console.WriteLine("Created gradebook {0}.", parts[2]);
            }
        ...
        public static void HelpCommand()
        {
            ...
            Console.WriteLine("Create 'Name' 'Type' 'Weighted' - Creates a new gradebook where " +
                "'Name' is the name of the gradebook, 'Type' is what type of grading it should use, " +
